...
A RAG system, using [LangChain](langchain.com), [OpenCode](https://opencode.ai/) and [Ollama](https://www.ollama.com/) to find code snippets and files on your machine, using natural language.
